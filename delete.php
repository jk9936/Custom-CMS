...
while ($row=mysqli_fetch_array($res))
{
	...
	echo "</td>";
	echo "<td>";
	echo "<form method='POST' action='delete_records.php'><input type='hidden' value=".$row['Username']." name='id'/><input type='submit' value='Remove'/></form>";
	//echo "<a href='delete_records.php?id=$row[Username]'>Delete Records</a>";
	echo "</td>";
	echo "</tr>";
}
